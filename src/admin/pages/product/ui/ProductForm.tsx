...
export const ProductForm = ({ title, subtitle, product, onSubmit, isPending }: Props) => {
    ...
    const removeTag = (tagToRemove: string) => {
        ...
        const removeTag = new Set(getValues('tags'));
        removeTag.delete(tagToRemove);
        setValue('tags', Array.from(removeTag))
    ...
    const removeSize = (sizeToRemove: Size) => {
        ...
        const removeSize = new Set(getValues('sizes'));
        removeSize.delete(sizeToRemove)
        setValue('sizes', Array.from(removeSize))
    };
                        ...
                        <div className="bg-white rounded-xl shadow-lg border border-slate-200 p-6">
                            ...
                            <div className="space-y-6">
                                <div>
                                    ...
                                    {
                                        errors.title && (
                                            <p className="text-sm text-red-500">El título es requrido.</p>
                                        )
                                    }
                                </div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div>
                                        ...
                                        <input
                                            ...
                                            className={cn(`w-full px-4 py-3 border focus:ring-2 focus:ring-blue-500 focus:border-transparent border-slate-300 rounded-lg  transition-all duration-200`,
                                                {
                                                    'border-red-500': errors.title
                                                }
                                            )}
                                        ...
                                        {
                                            errors.price && (
                                                <p className="text-sm text-red-500">El precio debe ser mayor a 0.</p>
                                            )
                                        }
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        {
                                            errors.stock && (
                                                <p className="text-sm text-red-500">El Inventario debe ser mayor a 0.</p>
                                            )
                                        }
                                    </div>
                                </div>
                                ...
                                <div>
                                    ...
                                    <input
                                        type="text"
                                        {...register('slug', {
                                            validate: (value) => !/\s/.test(value) || "El slug no pude tener espacios en blanco."
                                        })}
                                        className={cn(`w-full px-4 py-3 border focus:ring-2 focus:ring-blue-500 focus:border-transparent border-slate-300 rounded-lg  transition-all duration-200`,
                                            {
                                    ...
                                    {
                                        errors.slug && (
                                            <p className="text-sm text-red-500">{errors.slug.message || "El slug es requerido."}</p>
                                        )
                                    }
                                </div>
                                ...
                                <div>
                                    ...
                                    {
                                        errors.description && (
                                            <p className="text-sm text-red-500">{"La descripción es requerida."}</p>
                                        )
                                    }
                                </div>
                            </div>
