            ...
            <Table className="bg-white p-10 shadow-xs border-gray-200 mb-10">
                ...
                <TableBody>
                    <TableRow>
                        ...
                        <TableCell className="text-cemter">Producto 1</TableCell>
                        <TableCell className="text-right">$250.00</TableCell>
                        <TableCell className="text-right">Categoría 1</TableCell>
                        <TableCell className="text-right">100 stock</TableCell>
                        <TableCell className="text-right">XS, L, S</TableCell>
