...
export const FilterSidebar = () => {
    ...
    const handdlePrices = (price: string) => {
    ...
    const handdleSizeChange = (size: string) => {
                ...
                <div className="grid grid-cols-3 gap-2">
                    {sizes.map((size) => (
                        <Button
                            ...
                            size="sm"
                            className="h-8"
                            onClick={() => handdleSizeChange(size.id)}
                        >
                            {size.label}
                        </Button>
                    ))}
